...
export function projectYearlyBalances(profile, phases, events, targetRetirementAge, customLifeExpectancy = null) {
  ...
  let hysaBalance = context.hysaBalance;
  let balances = context.balances;
  let activeLoans = context.activeLoans;
  let customAssets = context.customAssets;
  let customHouses = context.customHouses;
  let customChildren = context.customChildren;
  let customObligations = context.customObligations;
